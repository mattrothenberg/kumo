...
export default function (plop) {
  ...
  plop.setActionType('modify-json', (answers, config) => {
    ...
    fs.writeFileSync(filePath, JSON.stringify(modifiedJson, null, '\t') + '\n', 'utf8');
    ...
    prompts: [
      {
        ...
        validate: (value) => {
          ...
          if (value.length < 2) return 'Block name must be at least 2 characters';
          return true;
        },
      },
    ],
    ...
    prompts: [
      {
        ...
        validate: (value) => {
          ...
          if (value.length < 2) return 'Layout name must be at least 2 characters';
          return true;
        },
      },
    ],
