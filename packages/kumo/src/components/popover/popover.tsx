  ...
  return (
    <PopoverBase.Portal>
      ...
      >
        <PopoverBase.Popup
          className={cn(
            "flex origin-[var(--transform-origin)] flex-col rounded-lg bg-surface px-4 py-3 text-sm text-surface",
...
function PopoverDescription({ className, ...props }: PopoverDescriptionProps) {
  return (
    <PopoverBase.Description
      className={cn("m-0 text-base leading-6 text-muted", className)}
      {...props}
    />
  );
}
  ...
  return (
    <svg width="20" height="10" viewBox="0 0 20 10" fill="none" {...props}>
      ...
      <path
        ...
        className="fill-tooltip-arrow-outer-stroke"
      />
      <path
        d="M10.3333 3.34539L5.47654 7.71648C4.55842 8.54279 3.36693 9 2.13172 9H0V8H2.13172C3.11989 8 4.07308 7.63423 4.80758 6.97318L9.66437 2.60207C10.0447 2.25979 10.622 2.2598 11.0023 2.60207L15.8591 6.97318C16.5936 7.63423 17.5468 8 18.5349 8H20V9H18.5349C17.2998 9 16.1083 8.54278 15.1901 7.71648L10.3333 3.34539Z"
        className="fill-tooltip-arrow-inner-stroke"
      />
    </svg>
  );
}
