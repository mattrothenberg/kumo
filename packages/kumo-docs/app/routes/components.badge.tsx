      ...
      <ComponentSection>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-8">
            ...
            <div>
              <h4 className="mb-3 text-base font-medium">Beta</h4>
              <ComponentExample code={`<Badge variant="beta">Beta</Badge>`}>
                <Badge variant="beta">Beta</Badge>
              </ComponentExample>
            </div>
          </div>
        ...
        {/* In a sentence */}
        <div className="mb-12">
          <h3 className="mb-4 text-xl font-semibold">In a sentence</h3>
          <ComponentExample
