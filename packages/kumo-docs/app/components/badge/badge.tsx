...
export function Badge({ variant = "primary", className, children }: 
  ...
  return (
    <span className={cn(
      ...
      variant === "outline" 
      ? "bg-transparent border border-neutral-200 text-black dark:border-neutral-800 dark:text-white" 
      : "",
      variant === "primary" 
      ...
      : "",
      variant === "beta" 
      ? "bg-transparent border border-dashed border-blue-400 text-blue-600 dark:border-blue-500 dark:text-blue-400" 
      : "",
      className
    )}>
      {children}
