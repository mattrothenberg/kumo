      ...
      >
        ...
        <div className="flex items-center gap-3 border-b border-border p-4">
          ...
          <input
            ...
            className="flex-1 bg-transparent text-base text-surface outline-none placeholder:text-muted"
            aria-label="Search documentation"
          />
          {loading && <Loader size="sm" />}
          <kbd className="hidden items-center gap-1 rounded border border-border bg-secondary px-2 py-1 text-xs text-muted sm:inline-flex">
            ESC
          </kbd>
        </div>
                  ...
                  <li key={result.url}>
                    ...
                    >
                      <div className="mb-1 flex items-center gap-2">
                        ...
                        <h3 className="font-medium text-surface">
                          {displayTitle}
                        </h3>
                      </div>
                      {result.excerpt && (
                        <p
                          className="line-clamp-2 text-sm text-label [&_mark]:rounded-sm [&_mark]:bg-yellow-200 [&_mark]:px-0.5 [&_mark]:text-surface dark:[&_mark]:bg-yellow-500/30"
        ...
        {/* Footer */}
        {results.length > 0 && (
          <div className="flex items-center justify-between border-t border-border bg-secondary px-4 py-2 text-xs text-muted">
            <span>
