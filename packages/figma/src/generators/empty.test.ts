...
describe("Empty Generator - Snapshots", () => {
  it("should produce consistent size config", () => {
    expect(getEmptySizeConfig()).toMatchSnapshot();
  });

  it("should produce consistent base styles", () => {
    expect(getEmptyParsedBaseStyles()).toMatchSnapshot();
  });

  it("should produce consistent icon config", () => {
    expect(getEmptyIconConfig()).toMatchSnapshot();
  });

  it("should produce consistent text config", () => {
    expect(getEmptyTextConfig()).toMatchSnapshot();
  });

  it("should produce consistent complete data", () => {
    expect(getAllEmptyData()).toMatchSnapshot();
  });
});
